<div class="jumbotron text-center">
	<div class="container">
		<h1>Blacklist</h1>
		<p class="lead">On the blacklist page you can add ip-addresses that are not allowed to connect to any port of your server.<br>Use this carefully and check periodically if the addresses are nessesary any more.<br>You can add IPv4 and IPv6 adresses here.</p>
	</div>
</div>
